...
root.configure(background='#4CAF50')
...
input_label = tk.Label(root, text="Enter temperature", background='#DCE775', foreground="#000000")
input_entry = tk.Entry(root, textvariable=numberInput)
input_label.grid(row=1)
input_entry.grid(row=1, column=1)

result_label1 = tk.Label(root, background='#4CAF50', foreground="#000000")
result_label1.grid(row=3, columnspan=4)
result_label2 = tk.Label(root, background='#4CAF50', foreground="#000000")
...
dropdown.config(background='#DCE775', foreground="#000000")
dropdown["menu"].config(background='#4CAF50', foreground="#000000")

call_convert = partial(call_convert, result_label1, result_label2, numberInput)
result_button = tk.Button(root, text="Convert", command=call_convert, background='#DCE775', foreground="#000000")
